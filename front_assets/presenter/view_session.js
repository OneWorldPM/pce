...
");
                        ...
                        $.each(data.result.option, function (key, val) {
                            ...
                            if (data.result.max_value == val.total_vot) {
                                ...
                                $("#result_section").append("<div class='progress' style='margin-bottom: 25px;'><div class='progress_bar_new "+zeroVotes+"' role='progressbar' aria-valuenow='" + result_calculate.toFixed(0) + "' aria-valuemin='0' aria-valuemax='100' style='width:" + (parseInt(result_calculate.toFixed(0) ) +3) + "%'>" + result_calculate.toFixed(0) + "%</div></div>");
                            } else {
                                if(!window.isComparisonpoll)
                                {
                                    $('.progress_bar_new').css('background', '#45c0ea');
                                ...
                                $("#result_section").append("<div class='progress' style='margin-bottom: 25px;'><div class='progress-bar assesment-bar "+zeroVotes+"' role='progressbar' aria-valuenow='" + result_calculate.toFixed(0) + "' aria-valuemin='0' aria-valuemax='100' style='width:" + (parseInt(result_calculate.toFixed(0) ) +3) + "%'>" + result_calculate.toFixed(0) + "%</div></div>");
                            }
